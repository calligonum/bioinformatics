...
<div class="leftmenu">
	<%@include file="adminmenu.jsp" %>	
       ...
       <c:forEach var="datasetsList" items="${datasetsList}">
       	<tr>
       	<form method="post" action = "/bioinformatics/UpdateDatasetsServlet">
		<td><input class="inputid" type="text" name="id" value="${datasetsList.id}" readonly onclick="alert('警告：ID号不允许修改！')"/></td>
