...
<div class="leftmenu">
	<%@include file="adminmenu.jsp" %>	
       ...
       <c:forEach var="teamList" items="${teamList}">
		...
		<tr>
		 <form method="post" action = "/bioinformatics/UpdateTeamServlet">
		<td><input class="inputid" type="text" name="id" value="${teamList.id}" readonly onclick="alert('警告：ID号不允许修改！')"/></td>
		<td><input type="text" name="name" value="${teamList.name}"/></td>
		<td><input type="text" name="professional" value="${teamList.professional}"/>  </td>
		<td><input type="text" name="study" value="${teamList.study}"/> </td>
