...
<div class="leftmenu">
	<%@include file="adminmenu.jsp" %>	
    	...
    	<td class="admintabletitle">课程名称</td>
		</tr>
    <c:forEach var="classList" items="${classList}">
       	<tr>
       	<form method="post" action = "/bioinformatics/UpdateClassesServlet">
		<td><input class="inputid" type="text" name="id" value="${classList.id}" readonly onclick="alert('警告：ID号不允许修改！')"/></td>
		<td><input type="text" name="classes" value="${classList.classes}"/></td>
