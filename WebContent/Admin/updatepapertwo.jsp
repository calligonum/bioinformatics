...
<body>
		...
		<tr>
		 <form  method="post" action = "/bioinformatics/UpdatePaperServlet" >
		<td><input class="inputid" type="text" name="paperid" value="${papersList.id}" readonly onclick="alert('警告：ID号不允许修改！')"/>  </td>
